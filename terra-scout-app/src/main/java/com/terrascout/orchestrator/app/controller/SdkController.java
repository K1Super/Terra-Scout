...
/**
 * SDK 端点：版本列表 / 异步安装 / 安装进度 / 卸载 / 元数据重载。
 */
@RestController
...
public class SdkController {
    ...
    /** 安装：异步任务，立即返回 jobId；已装版本直接返回 SUCCESS 记录。 */
    @PostMapping("/install")
    ...
    /** 取消安装任务：置取消信号；工作线程停止下载/解压并清理残留后收敛 CANCELLED。 */
    ...
    public static class SdkInstallRequest {
        ...
        /** 可选：自定义安装根目录（绝对路径）；缺省回落标准仓库 {data-root}\sdks。 */
